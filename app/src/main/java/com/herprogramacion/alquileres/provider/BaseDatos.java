...
public class BaseDatos extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        valores.put(Propuestas.LAT, "40.4172181");
        valores.put(Propuestas.LON, "-3.7081674");
        ...
        valores.put(Propuestas.CATEGORIA, "Movilidad");
        valores.put(Propuestas.LAT, "40.3969981");
        valores.put(Propuestas.LON, "-3.6925345");
        valores.put(Propuestas.USER_NAME, "Pedro");
        valores.put(Propuestas.FOTO_USERCOM, "https://www.hackityapp.com/modules/custom/hck_comment/img/default-avatar.png");
        valores.put(Propuestas.BODY_COMMENT, "Hoy se celebra el día sin coches. Me gustaría que se celebrara más a menudo y que la gente pudiera moverse más en bici, transporte público o caminando");
        db.insertOrThrow(Tablas.PROPUESTAS_TB, null, valores);
        ...
        valores.put(Propuestas.LAT, "40.4172181");
        valores.put(Propuestas.LON, "-3.7081674");
        valores.put(Propuestas.USER_NAME, "Mario");
        valores.put(Propuestas.FOTO_USERCOM, "https://www.hackityapp.com/modules/custom/hck_comment/img/default-avatar.png");
        valores.put(Propuestas.BODY_COMMENT, "Hoy se celebra el día sin coches. Me gustaría que se celebrara más a menudo y que la gente pudiera moverse más en bici, transporte público o caminando");
        db.insertOrThrow(Tablas.PROPUESTAS_TB, null, valores);
        ...
        valores.put(Propuestas.CATEGORIA, "Movilidad");
        valores.put(Propuestas.LAT, "40.4413025");
        valores.put(Propuestas.LON, "-3.6948212");
        valores.put(Propuestas.USER_NAME, "Jose");
        valores.put(Propuestas.FOTO_USERCOM, "https://www.hackityapp.com/modules/custom/hck_comment/img/default-avatar.png");
        valores.put(Propuestas.BODY_COMMENT, "Hoy se celebra el día sin coches. Me gustaría que se celebrara más a menudo y que la gente pudiera moverse más en bici, transporte público o caminando");
        db.insertOrThrow(Tablas.PROPUESTAS_TB, null, valores);
        ...
        valores.put(Propuestas.CATEGORIA, "Movilidad");
        valores.put(Propuestas.LAT, "40.3828081");
        valores.put(Propuestas.LON, "-3.6649511");
